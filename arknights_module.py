...
async def classify_and_extract_ak_event(tweet_text, tweet_image):
    ...
    prompt = (
        ...
        "Start: <UNIX timestamp in UTC>\n"
        "End: <UNIX timestamp in UTC>\n"
        "```\n"
        "\n"
        "**DATE PARSING AND CONVERSION:**\n"
        "\n"
        "Expected date format: 'Month Day, Year, HH:MM (UTC-7)'\n"
        "Example: 'November 20, 2025, 08:00 (UTC-7)'\n"
        "\n"
        "Step-by-step conversion to UNIX timestamp:\n"
        "1. Identify the UTC-7 time from the tweet or image\n"
        "2. Convert to UTC by adding 7 hours to the time\n"
        "3. Convert to UNIX timestamp using the UTC datetime\n"
        "\n"
        "Conversion example:\n"
        "- Original: November 20, 2025, 08:00 (UTC-7)\n"
        "- Add 7 hours → November 20, 2025, 15:00 UTC\n"
        "- Convert to UNIX → 1732118400\n"
        "\n"
        "Important notes:\n"
        "- All Arknights EN times are in UTC-7 (Pacific Time)\n"
        "- ALWAYS add 7 hours before converting to UNIX timestamp\n"
        "- Be precise with hours - don't round or estimate\n"
        "\n"
        ...
        "  - Use the step-by-step conversion method above\n"
        "  - Double-check your timezone math (UTC-7 + 7 hours = UTC)\n"
        "\n"
        "**EXAMPLES:**\n"
        "\n"
        ...
        "```\n"
        "Calculation:\n"
        "- Start: Nov 20, 2025, 08:00 (UTC-7) + 7 hours = Nov 20, 2025, 15:00 UTC = 1732118400\n"
        "- End: Dec 4, 2025, 03:59 (UTC-7) + 7 hours = Dec 4, 2025, 10:59 UTC = 1733314740\n"
        "\n"
        ...
        "```\n"
        "Calculation:\n"
        "- Start: Sep 16, 2025, 10:00 (UTC-7) + 7 hours = Sep 16, 2025, 17:00 UTC = 1726498800\n"
        "- End: Sep 30, 2025, 03:59 (UTC-7) + 7 hours = Sep 30, 2025, 10:59 UTC = 1727701140\n"
        "\n"
