...
async def classify_and_extract_ak_event(tweet_text, tweet_image):
    ...
    prompt = (
        ...
        "  - For events: Use event name from tweet (e.g., 'Dissociative Recombination')\n"
        ...
        "  - 'Event' if mentions: episode, stages, new event\n"
        "  - 'Maintenance' if mentions: maintenance, server downtime\n"
        "\n"
        "- Start/End: Convert ALL dates to UNIX timestamps in UTC\n"
        "  - If tweet shows (UTC-7), convert to UTC before converting to UNIX\n"
        "  - Example: 'September 16, 2025, 10:00 (UTC-7)' = 1726498800 (UTC)\n"
        "\n"
        "**EXAMPLES:**\n"
        "\n"
        "Example 1 (Event - Banner):\n"
